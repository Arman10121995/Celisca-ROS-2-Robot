...
## Current evidence at source revision `e7a8cda` (2026-09-25)
...
| Quadruped | Go2 model imports; measured short stance, opt-in flat-ground policy forward/stop/turn, command-loss stop, direct foot contacts, feed-forward reverse sweep, opt-in inverse reverse A/B and two five-case flat-ground screening suites; terrain stairs fails at the first ledge | Repeatable velocity tracking, terrain traversal, bounded fall recovery and navigation; R5.2 is active |
