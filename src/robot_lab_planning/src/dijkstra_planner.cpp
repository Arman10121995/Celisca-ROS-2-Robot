...
#include "robot_lab_planning/dijkstra_planner.hpp"

namespace robot_lab_planning
{
...
PLUGINLIB_EXPORT_CLASS(robot_lab_planning::DijkstraPlanner, nav2_core::GlobalPlanner)