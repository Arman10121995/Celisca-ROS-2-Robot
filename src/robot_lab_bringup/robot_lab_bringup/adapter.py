...
This module provides the P2.4 functionality: wrapping bumperbot_bringup/simulated_robot.launch.py
...
class LegacyAdapter:
    ...
    def get_legacy_launch_file(self, robot_id: str) -> Optional[str]:
        ...
        if robot_id == 'bumperbot':
            return 'bumperbot_bringup/simulated_robot.launch.py'
        return None
...
def generate_adapter_launch_description():
    ...
    to legacy bumperbot_bringup arguments.
    """
    from launch import LaunchDescription
