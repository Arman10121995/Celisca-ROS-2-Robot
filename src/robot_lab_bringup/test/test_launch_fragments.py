...
def test_parameter_overlay():
    ...
    from robot_lab_bringup.launch_fragments import ParameterOverlay
...
def test_fragment_registry():
    ...
    from robot_lab_bringup.launch_fragments import (
    ...
    assert fragment.package == 'bumperbot_bringup'
